...
export const metadata: Metadata = {
  title: "Knowledge Studio — Guardian",
};
    ...
    <div className="min-h-screen bg-[var(--background)]">
      ...
      <main className="mx-auto max-w-5xl px-6 py-10">
        ...
        <p className="mt-3 max-w-2xl text-ink-muted">
          Teach Guardian trusted organizational knowledge, review it, then
          publish only what attendees are allowed to use.
        </p>
        <div className="mt-8 grid gap-4 md:grid-cols-2">
          ...
          >
            ...
            <h2 className="mt-1 text-xl font-semibold">CrossRoads Connect</h2>
            <p className="mt-2 text-sm text-ink-muted">
              Website scan, organization facts, events, review, and publish.
            </p>
          </Link>
        </div>
      </main>
