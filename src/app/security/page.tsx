...
const sections = [
  {
    ...
    paragraphs: [
      ...
      "If email reminders are enabled, we send deadline reminder emails to your sign-in address. With getting-started emails enabled, we may also send a welcome note and short setup tips. You can turn these off at any time from the Settings page.",
    ],
  },
  {
    id: "authentication",
