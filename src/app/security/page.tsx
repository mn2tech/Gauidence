...
const sections = [
  ...
  },
  {
    ...
    paragraphsAfter: [
      "What we can accurately say today: data is encrypted in transit, protected by authenticated access, and separated by account and vault membership. Opt-in document share links are time-limited and revocable. Client vault collaborator invites are owner-controlled and revocable.",
    ],
  },
  {
    id: "deleting-data",
