...
const sections = [
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "Ask your vault searches across your analyzed documents using embeddings (OpenAI) and answers with Claude, citing source file names. Retrieval is limited to your own account via Row Level Security.",
