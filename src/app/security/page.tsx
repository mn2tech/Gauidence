...
const sections = [
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "Ask Gideon searches only the active Guardian profile's vault (embeddings via OpenAI, answers via Claude). One login can own multiple profiles; each profile has separate documents, analyses, attention items, and conversations. Retrieval and chat history are limited to your account via Row Level Security, and to the active profile by profile_id.",
