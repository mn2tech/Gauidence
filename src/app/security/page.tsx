...
const sections = [
  ...
  },
  {
    ...
    paragraphs: [
      "When you upload a document, Guardian uses AI to extract key facts and generate plain-language explanations and recommendations. Guardian is designed to be transparent about the source of each statement: which facts came directly from your document, which dates were calculated, and which recommendations were generated by AI.",
