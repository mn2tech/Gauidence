...
const sections = [
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "Ask Gideon (Guardian's AI guide) searches across your analyzed documents using embeddings (OpenAI) and answers with Claude. Answers are grounded in retrieved excerpts from your vault, cite source file names when available, and distinguish document facts, calculations, suggestions, and uncertainty. Retrieval and chat history are limited to your own account via Row Level Security.",
