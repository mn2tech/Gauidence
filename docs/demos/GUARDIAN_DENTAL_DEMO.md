...
[`docs/fixtures/lagos-dental-centre-practice-profile.md`](../fixtures/lagos-dental-centre-practice-profile.md)
...
4. Upload the fixture markdown into the parent Space or **Clinical**.
5. Run **Analyze existing knowledge** (explicit).
